...
export const apocalypseWorldCharacterSchema = Type.Object(
    {
        ...
        brainer: Type.Optional(
            Type.Object(
                {
                    brainerGear: Type.Array(
